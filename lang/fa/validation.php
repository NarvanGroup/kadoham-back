...
return [
    ...
    */
    ...
    'alpha' => 'گزینه :attribute باید تنها شامل حروف انگلیسی باشد',
    'alpha_dash' => 'گزینه :attribute باید تنها شامل حروف انگلیسی، اعداد، خط تیره و زیر خط باشد',
    ...
    'current_password' => 'رمزعبور فعلی صحیح نمی باشد',
    ...
    'password' => [
        ...
        'mixed' => 'گزینه :attribute باید شامل حداقل یک حرف بزرگ و یک حرف کوچک انگلیسی باشد',
    ...
    'required_with' => 'تکمیل گزینه :attribute زمانی که مقدار :values تکمیل شده است الزامی است',
    'required_with_all' => 'تکمیل گزینه :attribute زمانی که مقادیر :values تکمیل شده است الزامی می باشد',
    'required_without' => 'تکمیل گزینه :attribute زمانی که مقدار :values تکمیل نشده است الزامی است',
    'required_without_all' => 'تکمیل حداقل یکی از گزینه های :attribute زمانی که هیچ کدام از مقادیر :values تکمیل نشده است الزامی است',
    ...
    */
    ...
    'attributes' => [
        ...
        'number' => 'واحد',
        'postal_code' => 'کد پستی',
        'isReceiver' => 'من دریافت کننده هستم',
        'card_number' => 'شماره کارت',
        'iban' => 'شماره شبا',
        'card_number_or_iban' => 'شماره کارت یا شماره شبا',
        'new_password' => 'رمز عبور جدید',
        'new_password_confirmation' => 'تایید رمز عبور جدید',
        'current_password' => 'رمز عبور فعلی',
        'payment_method' => 'روش پرداخت',
        'shipping_method' => 'روش ارسال',
        'products.*.quantity' => 'میزان محصول',
        'products.*.id' => 'شناسه محصول',
        'address_id' => 'آدرس',
        'products' => 'محصولات',
        'vendor_id' => 'شناسه فروشنده',
        'period' => 'بازه زمانی قرارداد',
        'rate' => 'نرخ سود',
        'amount' => 'مقدار محصول برای اجاره',
        'search' => 'جستوجو'
    ],
