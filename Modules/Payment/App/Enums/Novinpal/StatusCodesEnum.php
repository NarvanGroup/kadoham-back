...
enum StatusCodesEnum: int
{
    ...
    case TRANSACTION_NOT_FOUND = 105; // تراکنش یافت نشد
    case INVALID_REFERENCE_ID = 106; // شناسه مرجع اشتباه است
    case PSP_NOT_FOUND = 107; // PSP یافت نشد
    case SERVER_ERROR = 108; // خطای سرور
    case TRANSACTION_FAILED = 109; // تراکنش ناموفق بوده است
    ...
    case INVALID_ORDER_ID = 113; // شناسه سفارش اشتباه است
    ...
    case INVALID_CARD = 123; // کارت نامعتبر است (عدم تطبیق کارت ارسالی با کارت پرداختی)
}